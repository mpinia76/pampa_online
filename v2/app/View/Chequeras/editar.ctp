...
?>
<?php echo $this->Form->hidden('Chequera.id'); ?>
...
<div class="ym-grid">
    ...
    <div class="ym-g50 ym-gl" id="divInicio"><?php echo $this->Form->input('Chequera.inicio',array('label' => 'Nro. Inicio','type'=>'number','maxlength'=>'8'));?></div>
    <div class="ym-g50 ym-gl"><?php echo $this->Form->input('Chequera.final',array('label' => 'Nro. Final','type'=>'number','maxlength'=>'8'));?></div>
</div>
...
<span id="botonGuardar" onclick="guardar('<?php echo $this->Html->url('/chequeras/guardar.json', true);?>',$('form').serialize(),{id:'w_chequeras',url:'v2/chequeras/index'});" class="boton guardar">Guardar <img src="<?php echo $this->webroot; ?>img/loading_save.gif" class="loading" id="loading_save" /></span>
