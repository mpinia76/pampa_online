...
<div class="ym-grid" id="forma_cobro">
    ...
    <div class="ym-g25 ym-gl">
        <span id="btn_agregar_cobro" style="margin-top: 15px;" class="boton agregar" onclick="guardar('<?php echo $this->Html->url('/reserva_descuentos/guardar.json', true);?>',$('form').serialize(),{id:'w_reservas',url:'/v2/reservas/index'});">+ agregar</span>
    </div>
</div>
