<div class="content">
    <table width="100%">
        <tr>
            ...
            <td width="36%"  class="locacion">
                <span class="ciudad">Mar de las Pampas</span> <br/>
                Corvina e/Joaquin V. González y M. Sosa<br/>
                (02255)-454244 / (02255)-454243
            </td>
        </tr>
    </table>
    <hr/>
    ...
    <table width="680" align="center" cellpadding="3" cellspacing="3" border="0">
        ...
        <tr>
            <td width="200"><strong>Apartamento</strong></td>
            <td><?php echo $reserva['Apartamento']['apartamento'];?></td>
        </tr>
        <tr>
            <td width="200"><strong>Check In</strong></td>
            <td><?php echo $reserva['Reserva']['check_in'];?> 15:00 hs.</td>
        </tr>
        <tr>
