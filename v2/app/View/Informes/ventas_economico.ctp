    ...
    <tr class="contenido">
        ...
        <?php for($i=1; $i<=12; $i++){ ?>
        <td><?php echo $capacidad_total?></td>
        <?php } ?>
        <td>&nbsp;</td>
    </tr>
    <tr class="contenido">
    ...
    <tr class="contenido">
        ...
        <?php for($i=1; $i<=12; $i++){ ?>
        <td><?php echo $capacidad_total - $capacidad_ocupada[$i]?></td>
        <?php } ?>
        <td>&nbsp;</td>
    </tr>
    <tr class="contenido">
        ...
        <?php for($i=1; $i<=12; $i++){ ?>
        <td><?php echo number_format(($capacidad_ocupada[$i] / $capacidad_total)*100,2)?>%</td>
        <?php } ?>
        <td>&nbsp;</td>
    </tr>
    <tr class="contenido">
