<table width="100%" cellspacing="0">
    <tr class="titulo">
        ...
        <td colspan="<?=count($posnets)+1?>">Tarjetas</td>
    ...
    <tr class="contenido">
        ...
        <td class="total"><?=$cobro_neto[$j]?></td>
        <?php 
        $total_caja[$j] = 0;
        ...
        <? } ?>
         ...
         foreach($cobro_posnet as $posnet){
            ...
            <td><?=$posnet[$j]?></td>
         <? } ?>
            <td class="total"><?=$total_posnets[$j]?></td>
    ...
    <tr class="titulo">
        ...
        <td class="total2"><?=array_sum($cobro_neto)?></td>
        ...
        <?php  foreach($cobro_posnet as $id => $posnet){ ?>
         ...
         <? } ?>
        <td class="total2"><?=array_sum($total_posnets)?></td>
