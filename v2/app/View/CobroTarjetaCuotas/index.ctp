...
$this->Js->buffer('
    ...
    $("#locacion").change(function(){ 
        if($(this).val() == ""){
            ...
            oTable.fnFilter($("#locacion option:selected").text(),1);
         }
     });
');
$this->Js->buffer('
...
<ul class="action_bar">
    ...
    <li class="filtro">Locacion <?php  echo $this->Form->input('locacion',array('type' => 'select', 'options' => $locaciones, 'empty' => 'Seleccionar ...', 'label' => false, 'div' => false));?></li>
</ul>
<table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $tipo['CobroTarjetaPosnet']['posnet']; ?></td>
            <td><?php echo $tipo['CobroTarjetaTipo']['marca']; ?></td>
