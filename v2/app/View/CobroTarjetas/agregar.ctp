...
<div class="ym-grid">
    <div class="ym-g33 ym-gl"><div class="ym-gbox"><?php echo $this->Form->input('CobroTarjeta.lote'); ?></div></div>
    <div class="ym-g33 ym-gl"><div class="ym-gbox"><?php echo $this->Form->input('CobroTarjeta.autorizacion'); ?></div></div>
    <div class="ym-g33 ym-gl"><div class="ym-gbox"><?php echo $this->Form->input('CobroTarjeta.cupon'); ?></div></div>
</div>
<div class="ym-grid">
