...
?>
<div class="content">
    <h1><?php echo $this->Html->image('icon.jpg', array('height' => '30', 'align' => 'absmiddle')); ?> Check de consumos</h1>
    <hr/>
    <table width="100%">
        <tr>
       ...
       // print_r($extra);
        ...
        ?>
            <tr>
                ...
                <td class="border"><?php echo number_format(($extra['ReservaExtra']['precio']*$extra['ReservaExtra']['cantidad']),2, ',', '.');?></td>
            </tr>
        <?php } ?>
        <tr>
...
function descargar(){
	document.location = "<?php echo $this->Html->url('/reservas/check_consumo/'.$reserva['Reserva']['id'].'/1', true);?>";
