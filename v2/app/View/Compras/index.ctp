...
<ul class="action_bar">
    ...
    <?php if(isset($usuario_accion['129'])){ ?><li onclick="eliminar();"  class="boton anular">Eliminar</li><?php  } ?>
    <?php if(isset($usuario_accion['129'])){ ?><li onclick="borrar();"  class="boton anular">Anular Pago</li><?php  } ?>
