...
$this->Js->buffer('
    ...
    $("#filter_rubro").change(function(){ 
        if($(this).val() == ""){
            ...
            oTable.fnFilter($("#filter_rubro option:selected").text(),4);
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#filter_subrubro").change(function(){ 
                        if($(this).val() == ""){
                            ...
                            oTable.fnFilter($("#filter_subrubro option:selected").text(),5);
                         }
                     });
                }
            });
    ...
    $("#filter_estado").change(function(){ 
        if($(this).val() == ""){
            ...
            oTable.fnFilter($("#filter_estado option:selected").text(),9);
         }
     });
