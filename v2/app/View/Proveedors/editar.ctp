...
<span id="botonGuardar" onclick="guardar('<?php echo $this->Html->url('/proveedors/guardar.json', true);?>',$('form').serialize(),{id:'w_proveedors',url:'v2/proveedors/index'});" class="boton guardar">Guardar <img src="<?php echo $this->webroot; ?>img/loading_save.gif" class="loading" id="loading_save" /></span>
