	...
	public static function trace($options = array()) {
		...
		for ($i = $options['start']; $i < $count && $i < $options['depth']; $i++) {
			...
			if ($options['format'] == 'points' && $trace['file'] != '[internal]') {
				...
				$back[] = phpString::insert($tpl, $trace, array('before' => '{:', 'after' => '}'));
			}
		}
 ...
 *
 * Where $data is an array of strings that use phpString::insert() variable
	...
	public function outputError($data) {
		...
		if (isset($tpl['links'])) {
			foreach ($tpl['links'] as $key => $val) {
				$links[$key] = phpString::insert($val, $data, $insertOpts);
			}
		}
		...
		foreach ($infoData as $key => $value) {
			...
			$info .= phpString::insert($tpl[$key], array($key => $value) + $data, $insertOpts);
		}
		$links = join(' ', $links);
		...
		echo phpString::insert($tpl['error'], compact('links', 'info') + $data, $insertOpts);
	}
