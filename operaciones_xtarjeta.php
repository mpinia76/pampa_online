...
$json	= "operaciones_xtarjeta.json.php"; //json
...
function doInitGrid(){	
    ...
    mygrid.setHeader("Titular,Marca,Operacion,Fecha,Nro. Orden,Monto,Con tarjeta, Cuotas"); 		//nombre de las columnas
	mygrid.attachHeader("#select_filter,#select_filter,#select_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
	mygrid.attachHeader("&nbsp;,&nbsp;,&nbsp;,&nbsp;,&nbsp;,${#stat_total},${#stat_total},&nbsp;");
	mygrid.enablePaging(true,10,10,"pagingArea",true,"recinfoArea");
	mygrid.setInitWidths("*,*,100,100,70,90,90,70");
    mygrid.setColAlign("left,left,left,left,right,right,right,right");			//alineacion de las columnas
	mygrid.setColSorting("str,str,str,str,int,int,int,int");			//tipo datos para ordenar
	mygrid.setColTypes("ro,ro,ro,ro,ro,price,price,ro");				//editable o no
...
<div id="mygrid_container" style="width:100%;height:310px;"></div>
<ul id="menu">
