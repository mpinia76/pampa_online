...
if($totalAuditoria == 1) {
    ...
    $sql_update = "UPDATE usuario_auditoria SET last = now(), interaccion='Informes economico - Egresos', segundos = segundos + $elapsed_time_seconds WHERE usuario_id = " . $_SESSION['userid'] . " AND fecha = '$date'";
