...
<ul id="menu">
	...
	$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
				VALUES ('".$_SESSION['userid']."','".$_SESSION['usernombre']."','Informes de satisfaccion','".getRealIP()."')";
	mysql_query($sql);
    $date = date('Y-m-d');
    ...
    if($totalAuditoria == 1) {
        ...
        $sql_update = "UPDATE usuario_auditoria SET last = now(), interaccion='Informes de satisfaccion', segundos = segundos + $elapsed_time_seconds WHERE usuario_id = " . $_SESSION['userid'] . " AND fecha = '$date'";
...
<select name="ApartamentoId[]" multiple="multiple" style="float:left;height:40px; width:200px; margin:2px 0px" id="ApartamentoId">
	...
	<option value="<?php echo $rs['id']?>" <?php if(($_POST['ApartamentoId'])&&(in_array($rs['id'], $_POST['ApartamentoId']))){?> selected="selected" <?php } ?>><?php echo $rs['apartamento']?> </option>
...
if(isset($_POST)){
	...
	if(mysql_affected_rows()>0){
		...
		$preguntasContestadasAlimentos =0;
...
<?php
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeVentas" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php				
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeRecepcion" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeDesayuno" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeAlimentos" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeLimpieza" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeMantenimiento" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeRelax" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="8%"><div style="text-align:right; font-family: Arial, Helvetica, sans-serif;font-size: 15px;font-weight: bold;">Punt. <span id="puntajeSustentabilidad" style="border: 1px solid #1E679A; width: 100px; height:100px;"></span></div></td>
				<td width="42%">
<?php
				$etiquetas=array();		
				$valores=array();
...
?>
		...
		<?php 
			//print_r($promedios);
					//$sumaPromedios +=$promedios[$preg]/count($encuestas);
					//echo $preg.' '.$promedios[$preg]."/".count($encuestas);
