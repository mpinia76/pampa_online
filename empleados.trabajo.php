...
<div class="container">
	...
	<div class="label">Horas 0001</div>
		<div class="content">
		<input type="text" name="horas_0001" value="0" size="5" />
		</div>
		<div style="clear:both;"></div>

	<div class="label">Horas 0002</div>
		<div class="content">
			<input type="text" name="horas_0002" value="0" size="5" />
		</div>
		<div style="clear:both;"></div>
	...
	<div class="label">Espacio de trabajo</div>
		<div class="content">
	...
	<div class="label">% Sector 1</div>
		<div class="content">
			<input type="text" name="porcentaje_sector_1" value="" size="5" onKeyUp="if(this.value > 100 || this.value < 0){ alert('El valor debe ser entre 0 y 100'); this.value=''; $('.por_2').val(''); }else{ $('.por_2').val(100 - this.value); }" />
		</div>
		<div style="clear:both;"></div>
		
	<div class="label">% Sector 2</div>
		<div class="content">
			<input class="por_2" type="text" disabled="disabled" name="porcentaje_sector_2_temp" value="" size="5" />
			<input class="por_2" type="hidden" name="porcentaje_sector_2" value="" />
		</div>
		<div style="clear:both;"></div>
